...
namespace Errors {
    ...
    namespace Config {
        ...
        const string DirectiveArgumentPortNumberTooHigh(const string &ctx, const string &directive,
                                                        const string &argument);
        const string DirectiveArgumentPortNumberTooLow(const string &ctx, const string &directive,
                                                       const string &argument);
        const string DirectiveIPv6NotSupported(const string &ctx, const string &directive);
        const string DirectiveInvalidBooleanArgument(const string &ctx, const string &directive,
                                                     const string &argument);
        const string DirectiveInvalidIpAddressArgument(const string &ctx, const string &directive,
                                                       const string &argument);
        const string DirectiveInvalidSizeArgument(const string &ctx, const string &directive, const string &argument);
        const string DirectiveInvalidStatusCodeArgument(const string &ctx, const string &directive,
                                                        const string &argument);
        const string InvalidDirectiveArgument(const string &ctx, const string &directive, const string &argument,
                                              const Arguments &options);
        const string InvalidDirectiveArgumentCount(const string &ctx, const string &directive, int count, int min,
                                                   int max);
        const string UnknownDirective(const string &ctx, const string &directive);
        const string ZeroServers();
        const string DirectiveArgumentInvalidHttpUri(const string &ctx, const string &directive,
                                                     const string &argument);
        const string DirectiveArgumentInvalidDoubleQuotedString(const string &ctx, const string &directive,
                                                                const string &argument);
