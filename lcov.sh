...
lcov --quiet --no-external --demangle-cpp --capture --base-directory . --directory obj_c2 --output-file "${LCOV_OUT_DIR}/coverage.info"
genhtml --quiet "${LCOV_OUT_DIR}/coverage.info" --output-directory "${LCOV_OUT_DIR}"
